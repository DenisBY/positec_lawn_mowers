"""Support for Positec lawn mowers."""
...
DEFAULT_NAME = "positec_lawn_mower"
DOMAIN = "positec_lawn_mowers"
POSITEC_API = "positec_cloud_api"
SCAN_INTERVAL = timedelta(seconds=30)
FORCED_UPDATE = timedelta(minutes=30)
UPDATE_SIGNAL = "positec_cloud_update_signal"
...
async def async_setup(hass, config):
    """Set up the Positec Landroid Cloud component."""
    import pyworxcloud

    hass.data[POSITEC_API] = {}
    dev = 0
...
class WorxLandroidAPI:
    ...
    async def async_update(self, now=None):
        """Update the state cache from Positec API."""
